...
// Used by scripts/sim-record.sh to turn a simulator screen recording into
// frame-by-frame stills (no ffmpeg needed). Ported from the Amibroke repo's
// tools/extract-frames.swift — fully generic, no project-specific paths.
//
